...
//       },
// ];
var linksStats = function linksStats(arrObj) {
...
var uniqueStats = function uniqueStats(arrObj) {
  return new Set(arrObj.map(function (links) {
    return links.href;
  })).size;
...
var brokenStats = function brokenStats(arrObjValidate) {
  return arrObjValidate.filter(function (link) {
