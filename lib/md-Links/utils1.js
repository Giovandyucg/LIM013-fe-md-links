...
optionValidate('./test/prueba/yesenia.md').then(res => console.log(res)).catch(err => console.log(err)); // optionValidate('prueba1.md').then((res) => console.log(res)).catch((err)=>console.log(err))
